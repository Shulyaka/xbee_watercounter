"""DataUpdateCoordinator for xbee_watercounter."""
...
class XBeeWatercounterApiClient:
    """Class to fetch data from XBeeWatercounter."""
    ...
    def __init__(
        ...
        """Initialize the XBee Watercounter API Client."""
    ...
    def command(self, command, *args, retry_count=3, **kwargs):
        """Issue xbee watercounter command synchronously."""
        try:
    ...
    async def async_command(
        ...
        """Issue xbee watercounter command asynchronously."""
...
class XBeeWatercounterDataUpdateCoordinator(DataUpdateCoordinator):
    ...
    def __init__(
        ...
        """Initialize the XBee Watercounter Client."""
        super().__init__(
            hass=hass,
    ...
    async def async_update_data(self):
        ...
        if data["uptime"] > 0:
            for number in range(0, 3):
                data["counter"][number] = await self.client.async_command(
                    "counter", number
                )
